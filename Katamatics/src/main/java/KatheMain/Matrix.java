...
public final class Matrix<T> implements Cloneable
{
    ...
    /**
     * Returns a clone of this matrix. The field and elements are shallow-copied because
     * they are assumed to be immutable.
    ...
    /**
     * Swaps the two specified rows of this matrix. If the two row indices are the same,
     * the swap is a no-op.
    ...
    /**
     * Adds the first specified row in this matrix multiplied by the specified
     * factor to the second specified row.
    ...
    /**
     * Returns a new matrix representing this matrix multiplied by the specified matrix.
     * Requires the specified matrix to have
     * the same number of rows as this matrix's number of columns.
    ...
    /**
     * Converts this matrix to reduced row echelon form (RREF)
     * using Gauss-Jordan elimination.
     * Always succeeds, as long as the field follows
     * the mathematical rules and does not throw an exception.
     */
    ...
    /**
     * Returns the determinant of this matrix, and as a side effect
     * converts the matrix to row echelon form (REF).
     * Requires the matrix to be square. The leading coefficient of each row
     * is not guaranteed to be one.
     * Always succeeds, as long as the field follows the mathematical rules
